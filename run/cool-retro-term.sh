...
echo "The Wildflower theme at '$dir/cool-retro-term.json' have to be manually imported. (Thanks to MOROS for the theme.)"

# Launch qemu inside cool-retro-term
cool-retro-term --fullscreen --profile "Wildflower" --workdir "$dir/.." -e sh -c "$qemu 2>/dev/null"
